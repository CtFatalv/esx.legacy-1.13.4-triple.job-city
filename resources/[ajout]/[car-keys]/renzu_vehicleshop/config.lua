...
VehicleShop = {
    ...
    ['Police Vehicle Shop'] = { -- same with name
        ...
        shop = { -- if not vehicle is setup in Database SQL, we will use this
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='police',name="Police Car", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='police2',name="Police 2", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='police3',name="Police 3", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='police4',name="Police 4", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='police5',name="Police 5", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polgauntlet',name="Pol Gauntlet", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='poldominator10',name="Pol Dominator", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polimpaler5',name="Pol Impaler 5", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polimpaler6',name="Pol Impaler 6", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polfaction2',name="Pol Faction", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polgreenwood',name="Pol Greenwood", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polbuffalo',name="Pol Buffalo", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polbuffalo6',name="Pol Buffalo 6", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polcoquette4',name="Pol Coquette", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='poldorado',name="Pol Dorado", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polcaracara',name="Pol Caracara", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='polterminus',name="Pol Terminus", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='policet',name="Police Transport", grade = 4},
            ...
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='policeb2',name="Police Bike 2", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='pranger',name="Park Ranger", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='sheriff',name="Sheriff", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='sheriff2',name="Sheriff 2", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='fbi',name="FBI", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='fbi2',name="FBI 2", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='pbus',name="Police Bus", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='riot',name="Riot", grade = 4},
            {shop='Police Vehicle Shop',brand='Police',stock=50,price=0,model='riot2',name="Riot 2", grade = 4},
        },
    },
