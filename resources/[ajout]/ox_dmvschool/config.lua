...
Config.Question = {
    [1] = {
        {
            label = "Quelle est la couleur du panneau d'interdiction ?",
            options = {
                {
                    label = "Rouge",
                    correct = true
        ...
        {
            label = "Que signifie le panneau en forme de triangle ?",
            options = {
                {
        ...
        {
            label = "Que signifie un panneau de danger avec un appareil photo ?",
            options = {
                {
                ...
                {
                    label = "Zone d'interdiction de photographier",
                    correct = true
                }
            }
        },
        ...
        {
            label = "Que doit faire un conducteur à un passage à niveau avec barrières ouvete ?",
            options = {
                {
                    label = "Accélérer pour passer avant que les barrières ne se ferment complètement",
                    correct = false
                },
                {
                    label = "Traverser seulement si aucun train n'arrive",
                    correct = true
                },
                {
                    label = "Klaxonner et avancer",
                    correct = false
                }
            }
        },
        ...
        },
        {
            ...
            options = {
                {
                    label = "Voie réservée aux vélos",
                    correct = false
                },
                {
                    label = "Voie réservée aux piétons",
                    correct = true
                },
                {
                    label = "Voie réservée aux transports publics",
                    correct = false
                }
            }
        },
        {
            label = "Que signifie un panneau avec une croix de Saint-André (X rouge sur fond blanc) ?",
            options = {
                {
                ...
                {
                    label = "Zone de stationnement autorisé",
                    correct = false
                },
                {
                    label = "Zone piétonne",
        ...
        },
        {
            ...
            options = {
                ...
                {
                    label = "S'arrêter, céder le passage et avancer avec prudence",
                    correct = true
                },
                {
                    label = "Klaxonner pour prévenir les autres conducteurs",
                    correct = false
                }
            }
        },
        {
            label = "Que signifie un panneau de virage dangereux à gauche ?",
            options = {
                {
                ...
                {
                    label = "Présence d'un virage dangereux à gauche",
                    correct = true
                }
            }
        },
        ...
        },
        {
            ...
            options = {
                {
                    label = "Passage réservé uniquement aux vélos",
                    correct = false
                },
                {
                ...
                {
                    label = "Endroit où les piétons peuvent traverser en sécurité",
                    correct = true
                }
            }
        },
        {
            ...
            options = {
                {
                    label = "Début d'une zone à circulation limitée",
                    correct = false
                },
                {
                ...
                {
                    label = "Fin de la zone avec des restrictions d'accès",
                    correct = true
                }
            }
        },
        {
            ...
            options = {
                ...
                {
                    label = "Interdiction uniquement pour les camions",
                    correct = false
                },
                {
                    label = "Interdiction pour tous les véhicules motorisés",
                    correct = true
                }
            }
        },
        {
            ...
            options = {
                {
                    label = "Accélérer pour passer avant le changement de feu",
                    correct = false
                },
                {
                    label = "S'arrêter seulement s'il y a des véhicules dans l'intersection",
                    correct = true
                },
                {
        ...
        },
        {
            ...
            options = {
                {
                    label = "Interdiction uniquement aux cyclistes",
                    correct = false
                },
                {
                    label = "Interdiction uniquement aux piétons",
                    correct = true
                },
                {
        ...
        {
            label = "Que signifie un panneau d'interdiction aux véhicules tractant une remorque ?",
            options = {
                {
                    label = "Interdiction uniquement aux camping-cars",
                    correct = false
                },
                {
                    label = "Interdiction aux véhicules avec remorque",
                    correct = true
                },
                {
